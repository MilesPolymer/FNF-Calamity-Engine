...
class Cache extends MusicBeatState
{
	...
	override function create()
	{
		...
		var menuBG:FlxSprite = new FlxSprite().loadGraphic(Paths.image('ui/preloaderArt'));
		menuBG.screenCenter();
		add(menuBG);

		shitz = new FlxText(12, 670, 0, "Loading...", 12);
	...
	function cache()
	{
		...
		for (i in images)
		{
			...
			var data:BitmapData = BitmapData.fromFile("assets/images/characters/" + i);

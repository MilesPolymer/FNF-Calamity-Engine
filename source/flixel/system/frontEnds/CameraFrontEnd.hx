...
class CameraFrontEnd
{
	...
	public function insert<T:FlxCamera>(NewCamera:T, DefaultDrawTarget:Bool = true, index:Int = null):T
	{
		if (index == null)
			index = FlxG.game.getChildIndex(FlxG.game._inputContainer);

		FlxG.game.addChildAt(NewCamera.flashSprite, index);

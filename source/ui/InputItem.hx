...
class InputItem extends TextMenuItem
{
	...
	{
		var inputs:Array<Int> = config.PlayerSettings.player1.controls.getInputsFor(control, device);
	...
	{
		return inputID == -1 ? '---' : utilities.InputFormatter.format(inputID, device);
	}
}
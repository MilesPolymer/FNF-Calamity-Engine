...
class TitleState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		FlxG.save.bind('fizzy-engine', 'fizzybott');
	...
	function startIntro()
	{
		...
		titlestatebg = new FlxBackdrop(Paths.image('ui/titleBG'), 0.2, 0, true, true);
		...
		var logo:FlxSprite = new FlxSprite().loadGraphic(Paths.image('ui/logo'));
		logo.screenCenter();
		...
		credTextShit = new ui.Alphabet(0, 0, "ninjamuffin99\nPhantomArcade\nkawaisprite\nevilsk8er", true);
	...
	override function update(elapsed:Float)
	{
		...
		if (pressedEnter && !transitioning && skippedIntro)
		{
			...
			if (!substates.OutdatedSubState.leftState)
			{
	...
	function createCoolText(textArray:Array<String>)
	{
		...
		{
			var money:ui.Alphabet = new ui.Alphabet(0, 0, textArray[i], true, false);
	...
	{
		var coolText:ui.Alphabet = new ui.Alphabet(0, 0, text, true, false);
